"""
Django settings for hri_proj project.
...
SECRET_KEY = 'django-insecure-5$oo@&am4)pzjy9%f)np$1fhy_9@fju82sl9ea&f_kr4k@28w4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Allow all hosts for LAN access (development only)
...
WSGI_APPLICATION = 'hri_proj.wsgi.application'
